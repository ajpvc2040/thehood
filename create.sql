...
create table HoodUser (userCode varchar(255) not null, admin integer, parentHoodId_ integer, password varchar(255), hoodId integer, primary key (userCode)) engine=InnoDB
...
alter table HoodUser add constraint FKa1s1lm8pqy66olc3t9u7xkub8 foreign key (hoodId) references Hood (hoodId)
